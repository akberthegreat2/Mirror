"""Tests for the SQLite/filesystem storage backends."""
...
with warnings.catch_warnings():
    ...
    from mirror_core.storage import FileSystemBlobStore, SQLiteMetadataStore

from mirror_core.storage import MetadataRecord


def test_sqlite_metadata_store_round_trip(tmp_path: Path) -> None:
    """The SQLite metadata store should persist and reload structured records with datetime timestamps."""
